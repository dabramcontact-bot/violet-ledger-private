...
create table public.requests (
  ...
  article_numbers text not null default '',
  ...
  proposed_to_nikolai boolean not null default false,
  ...
  pi_signed_at date,
  status text not null default 'request' check (status in ('request','offer','calculation','proposed','pi_sent','revision','signed','unsuccessful')),
  ...
  expected_warehouse_at date,
  warehouse_arrived_at date,
